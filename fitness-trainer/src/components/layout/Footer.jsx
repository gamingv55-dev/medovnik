        ...
        <div className="footer__grid">
          <div className="footer__col footer__col--brand">
            <Link to="/" className="footer__logo">
              VK<span className="footer__logo-dot">.</span>
            </Link>
            <p className="footer__tagline">
              Тренирай умно.<br />Живей силно.
            </p>
          ...
          <div className="footer__col">
            <h4 className="footer__col-title">Бързи линкове</h4>
            ...
            <ul className="footer__contact-list">
              <li>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.62 3.36 2 2 0 0 1 3.6 1.1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.74a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.5 16.1z"/>
                </svg>
              ...
              <li>
                ...
                <span>victor.kostov@gmail.com</span>
              </li>
              <li>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="footer__col">
            <h4 className="footer__col-title">Работно време</h4>
            <ul className="footer__schedule">
              <li><span>Понеделник – Петък</span><span>08:00 – 21:00</span></li>
              <li><span>Събота</span><span>09:00 – 18:00</span></li>
              <li><span>Неделя</span><span>По договаряне</span></li>
            </ul>
            <p className="footer__online-note">Онлайн консултации — гъвкаво</p>
          </div>
        </div>

        <div className="footer__bottom">
          <p className="footer__copy">
            © {new Date().getFullYear()} Виктор Костов. Всички права запазени.
          </p>
        </div>
      </div>
    </footer>
